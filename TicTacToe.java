...
// Program start
	...
	//Winning move in Rows
	                        if( board[row+ONE] == board[row+TWO] && board[row + ONE ] == Computer_Symbol  )
	                        {
				...
				else if( board[row] == board[row+TWO] && board[row] == Computer_Symbol )
				{
				...
				else if( board[row] == board[row+ONE] && board[row] == Computer_Symbol )
				{
				 	board[row + ONE] = Computer_Symbol;
					AllowComp--;
					System.out.println("_______Computer Winning Move________r");
	...
	//Winning move in Column
	                if(AllowComp == TWO )
			{
				for(int col = ONE; col <= THREE ; col++)
		                {
		                        if( board[col + THREE] == board[col + SIX] && board[col + THREE ] == Computer_Symbol )
		                        {
						...
						System.out.println("_______Computer Winning Move________c");
		                        ...
		                        else if( board[col] ==  board[col + SIX ] && board[col] == Computer_Symbol )
		                        {
						 ...
						 System.out.println("_______Computer Winning Move________c");
		                        ...
		                        else if( board[col] == board[col + THREE] && board[col] == Computer_Symbol )
		                        {
		                                board[col + THREE] = Computer_Symbol;
						AllowComp--; 
						System.out.println("_______Computer Winning Move________c");
	...
	//Winning move in Diagonal
			...
			if(AllowComp == TWO)
			{
		                if((board[ONE] == board[NINE] && board[NINE] == Computer_Symbol ) && (board[THREE] == board[SEVEN] && board[SEVEN] == Computer_Symbol))
				{
				...
				else if(board[FIVE] == board[NINE] && board[NINE] == Computer_Symbol )
				{
				...
				else if(board[FIVE] == board[ONE] && board[FIVE] == Computer_Symbol )
		                {
		                        board[NINE] = Computer_Symbol;
		                        AllowComp--;
					System.out.println("_______Computer Winning Move________9d");
			        }
				else if(board[FIVE] == board[SEVEN] && board[SEVEN] == Computer_Symbol )
		                {
					...
					System.out.println("_______Computer Winning Move________3d");
		                ...
		                else if(board[FIVE] == board[THREE] && board[FIVE] == Computer_Symbol )
		                {
